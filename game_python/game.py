        ...
        if game_started:
            ...
            for step in range(substeps):
                ...
                if ball_r >= R_cyl - ball.radius:
                    ...
                    if v_dot_n > 0:
                        # Rebound with e = 0.95 restitution
                        ball.vel[0] -= 1.95 * v_dot_n * nx
                        ball.vel[1] -= 1.95 * v_dot_n * ny
                ...
                if d_ring <= ball.radius:
                    ...
                    if v_dot_col < 0:
                        # Rebound with e = 0.95 restitution
                        ball.vel[0] -= 1.95 * v_dot_col * n_col_x
                        ball.vel[1] -= 1.95 * v_dot_col * n_col_y
                        ball.vel[2] -= 1.95 * v_dot_col * n_col_z
                        # Project back to contact boundary ONLY when colliding!
